...
import { get, ref, remove, update } from 'https://www.gstatic.com/firebasejs/9.6.6/firebase-database.js';
		...
		el.addEventListener('click', async function (e) {
			try {
				await updateCommitteeData(e.target.parentElement.parentElement.id, {
					name: e.target.parentElement.parentElement.querySelector('.committee-title').querySelector('input')
						.value,
